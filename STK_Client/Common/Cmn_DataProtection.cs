...
{
	[Serializable()]
	public sealed class Cmn_DataProtection
	{
		[Flags()]
	...
	internal class DPAPI
	{
		...
		public static extern bool CryptProtectData(ref DATA_BLOB dataIn, string szDataDescr, IntPtr optionalEntropy, IntPtr pvReserved,
			IntPtr pPromptStruct, Cmn_DataProtection.CryptProtectDataFlags dwFlags, ref DATA_BLOB pDataOut);

		[DllImport("crypt32")]
		public static extern bool CryptUnprotectData(ref DATA_BLOB dataIn, StringBuilder ppszDataDescr, IntPtr optionalEntropy,
			IntPtr pvReserved, IntPtr pPromptStruct, Cmn_DataProtection.CryptProtectDataFlags dwFlags, ref DATA_BLOB pDataOut);
